...
import { LayoutTemplate, X, Menu, ArrowRight, Download, Zap } from 'lucide-react';
        ...
        <div className={landingPageStyles.headerContainer}>
          ...
          <div className={landingPageStyles.logoContainer}>
            <div className={landingPageStyles.logoIcon}>
              <LayoutTemplate className={landingPageStyles.logoInner} />
            </div>
 ...
 {/*MAIN CONTENT*/}
    ...
    <p className={landingPageStyles.description}>
      Lorem ipsum, dolor sit amet consectetur adipisicing elit.
       Eos officiis voluptatem autem, illum eaque aliqu.
    </p>
    ...
    <div className={landingPageStyles.ctaCard}>
      ...
      <div className={landingPageStyles.ctaCardContent}>
        ...
        <button className={landingPageStyles.ctaButton} onClick={handleCTA}>
          ...
          <span className={landingPageStyles.ctaButtonText}>GET START BUILDING</span>
        </button>
      </div>
    </div>
  </div>
