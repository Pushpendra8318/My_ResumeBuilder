...
import { buttonStyles, contactInfoStyles, containerStyles, iconStyles, modalStyles, statusStyles } from '../assets/dummystyle'
import { TitleInput } from './Input'
import { useNavigate, useParams } from 'react-router-dom'
import { AlertCircle, ArrowLeft, Check, Container, Download, Loader2, Palette, Save, Trash2 } from 'lucide-react'
...
//it heps in downloading the resumes
...
const downloadPDF = async () => {
  ...
  //HOW IT WILL LOOK WHEN IT IS DOWNLOADED
    try {
      await html2pdf()
        .set({
          margin:       0,
 ...
 //THEME 
  ...
  return (
   <DashboardLayout>
    <div className={contactInfoStyles.main}>
  ...
  <div className={containerStyles.formContainer}>
    ...
    showActionBtn
    actionBtnText={isDownloading?"Generating...":downloadSuccess?"Downloaded":"Downoaded PDF"}
      actionBtnIcon={
        isDownloading?(
          <Loader2 size={16} className='animate-spin'/>
        ):
    ...
    >
       <div className='relative'>
        ...
        <div className={containerStyles.getPreview}>
